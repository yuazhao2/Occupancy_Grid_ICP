...
#使用ICP对给定两个点云进行配准，无visualisation,适合命令行批量处理
#使用方法：
#python ICP.py source.pcd target.pcd initialisation.txt result.txt
...
if __name__ == "__main__":   
    ...
    print("Point to Point ICP registration took %.3f sec.\n" % (time.time() - start))
    print(result_ICP)
